  ...
  return(
    <div className="col contenido">
      ...
      <div className="ventana">
        <div className="row">
          <div className="col">
            <Title total={images.length} categoria='images'/>
          </div>
        </div>
        <div className="row mb-3">
          <div className="col-4">
            <List categoria='images' contenido={images}/>
          </div>
          <div className="col-8">
            <div className="row mb-3">
              <Switch>
                <Route path="/images/add" render={() => <ImageForm {...other} images={images}/>}/>
                <Route path="/images/:imageId" render={({ match }) => (<ImageDetails {...other} image={images.find(i => i.id == match.params.imageId)}/>)}/>
              </Switch>
